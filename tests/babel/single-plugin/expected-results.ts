...
export const jestSetupCodeResultWithSortImportsPlugin = `// Optional: configure or set up a testing framework before each test.
...
export const jestSetupCodeResultWithoutSortImportsPlugin = `// Optional: configure or set up a testing framework before each test.
// If you delete this file, remove \`setupFilesAfterEnv\` from \`jest.config.js\`
