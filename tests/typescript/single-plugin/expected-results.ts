...
export const nextAPIRouteCodeResultWithBraceStylePlugin = `// Next.js API route support: https://nextjs.org/docs/api-routes/introduction
...
export const nextAPIRouteCodeResultWithoutBraceStylePlugin = `// Next.js API route support: https://nextjs.org/docs/api-routes/introduction
import type { NextApiRequest, NextApiResponse } from "next";
