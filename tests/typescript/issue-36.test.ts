...
const fixtures: Fixture[] = [
  {
    name: 'issue #36 - original case of issue #34',
    input: String.raw`
...
`,
    output: String.raw`/* eslint-disable @typescript-eslint/no-non-null-assertion */
import ts from 'typescript';
import commonjs from '@rollup/plugin-commonjs';
import rollupTerser from '@rollup/plugin-terser';
import rollupTypescript from '@rollup/plugin-typescript';
...
`,
    options: {
      ...
      // Note: To avoid reporting TS errors.
      ...{
      ...
      singleQuote: true,
      tabWidth: 4,
      // Note: To make input/output easier.
      useTabs: false,
      trailingComma: 'es5',
      quoteProps: 'preserve',
      printWidth: 100,
